...
## __NOTE:__ This changelog is no longer actively maintained. It is kept here for historical purposes.

Please refer to [DP+ Releases](https://github.com/dathere/datapusher-plus/releases)
which will now be the official changelog.
## [0.1.0] - 2022-09-09

...
5. Install [qsv](https://github.com/jqnatividad/qsv).
    ...
    ```bash
    wget https://github.com/jqnatividad/qsv/releases/download/0.123.0/qsv-0.123.0-x86_64-unknown-linux-gnu.zip
    unzip qsv-0.123.0-x86_64-unknown-linux-gnu.zip
    rm qsv-0.123.0-x86_64-unknown-linux-gnu.zip
...
1. Manual Deployment
    ...
    wget https://github.com/jqnatividad/qsv/releases/download/0.123.0/qsv-0.123.0-x86_64-unknown-linux-gnu.zip -P /tmp
    unzip /tmp/qsv-0.123.0-x86_64-unknown-linux-gnu.zip -d /tmp
    rm /tmp/qsv-0.123.0-x86_64-unknown-linux-gnu.zip
    ...
    # https://github.com/jqnatividad/qsv/releases/download/0.123.0/qsv-0.123.0-x86_64-unknown-linux-musl.zip

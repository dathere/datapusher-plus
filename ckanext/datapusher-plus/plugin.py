...
# import ckanext.datapusher-plus.views as views
# import ckanext.datapusher-plus.helpers as helpers
# import ckanext.datapusher-plus.logic.action as action
# import ckanext.datapusher-plus.logic.auth as auth
...
class DatapusherPlusPlugin(p.SingletonPlugin):
    ...
    def update_config(self, config: CKANConfig):
        ...
        p.toolkit.add_resource('assets', 'datapusher-plus')
